...
type ComplexityRoot struct {
	Mutation struct {
		Test func(childComplexity int, input string) int
	}
...
type MutationResolver interface {
	Test(ctx context.Context, input string) (string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.test":
		...
		return e.complexity.Mutation.Test(childComplexity, args["input"].(string)), true
...
func (ec *executionContext) _Mutation_test(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().Test(rctx, fc.Args["input"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
